  ...
  _sampaiTujuan(){
    return showDialog(
      ...
      builder: (context)=>AlertDialog(
        content: Text('O ônibus chegou ao seu destino ${widget.bus.halteName}..'),
        actions: <Widget>[
          FlatButton(
            child: Text('OK'),
            onPressed: (){
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                SizedBox(height: 5,),
                                                Text(
                                                  'Trajeto mais rápido de chegada',
                                        ...
                                        Card(
                                          ...
                                          child: ListTile(
                                            ...
                                            subtitle: Column(
                                              ...
                                              children: <Widget>[
                                                SizedBox(height: 2,),
                                                Text( 'BusaoSTM', style: TextStyle(color: Colors.black54, fontSize: 18)),
                                                SizedBox(height: 2,),

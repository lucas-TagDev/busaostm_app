...
class _HomePageState extends State<HomePage> {
  ...
  LatLng _initialLocation = LatLng(-2.4426063, -54.728579);
  Position _currentPosition;
  final Set<Marker> _markers = {};
  Circle _circle;
  BitmapDescriptor iconHalte;
  BitmapDescriptor iconMe;
  var _API = 'AIzaSyAQxLbEz0vImixlpoxD9QopDTdtWhk3qmU';
  Dio dio = new Dio();
  ...
  var _jarak;
    ...
    try{
      ...
      print('Distância : ' + (_distanceMatrix.elements[0].distance.value/1000).toStringAsFixed(1) + ' km');
      setState(() {
      ...
      Scaffold.of(context).showSnackBar(SnackBar(
        ...
        content: Text('A distância para você chegar nessa parada é de: $_jarak km'),
      ));
  ...
  void createCurrentMarker(Position pos){
    this.setState(() {
      _markers.add(Marker(
        markerId: MarkerId('Você está aqui'),
        icon: iconMe,

...
class _ProfileState extends State<Profile> {
  ...
  void _changePassword(String password) async{
    ...
    user.updatePassword(password).then((_){
      ...
      print("Não foi possível alterar sua senha" + error.toString());
    ...
    _showConfirm(){
      return showDialog(
        ...
        builder: (context)=>AlertDialog(
          content: Text('Deseja realmente encerrar sua sessão?'),
          actions: <Widget>[
            FlatButton(
              child: Text('NÃO'),
              onPressed: (){
    ...
    _showPrivacyPolicy(){
      return showDialog(
        ...
        builder: (context)=>AlertDialog(
          ...
          title: Center(child: Text("Política de Privacidade")),
          content: Container(
            height: 200,
            width: 300,
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('Nome',style: TextStyle(color: Colors.black54),),
                    Padding(
                          ...
                          Expanded(
                            child: Column(
                              children: <Widget>[
                                ...
                                Text('Telefone',style: TextStyle(color: Colors.black54),),
                              ],
                            ),
                          ),
                        ],
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ListTile(
                      ...
                      title: Text('Sobre nós', style: TextStyle(color: Colors.black54),),
                    ),
                    ListTile(
                      leading: FaIcon(FontAwesomeIcons.idBadge, color: Colors.black54,) ,
                      title: Text('Política de Privacidade', style: TextStyle(color: Colors.black54),),
                      onTap: (){
                        _showPrivacyPolicy();
                      },
                    ),
                    ListTile(
                      ...
                      title: Text('Termos e Condições de uso', style: TextStyle(color: Colors.black54),),
                      onTap: (){
                        _showTermsCondition();
                      },
                    ),
